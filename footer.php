...
?>
	...
	<footer id="colophon" class="site-footer">
		<div class="site-info">
			<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'veropeluqueria' ) ); ?>">
				<?php
			...
			<span class="sep"> | </span>
				...
				printf( esc_html__( 'Theme: %1$s by %2$s.', 'veropeluqueria' ), 'veropeluqueria', '<a href="http://underscores.me/">Underscores.me</a>' );
				?>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
